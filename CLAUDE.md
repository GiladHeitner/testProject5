...
- 🎯 **Muslim-Rants-era content steering shipped 2026-07-01** (`reddit_topics.py`): +6 priority for concrete-incident/injustice sources (`_INCIDENT_KEYWORDS`), −4 for opinion-musing titles ("Why do people think..."), and **out-of-season Ramadan sources hard-rejected** (`is_ramadan_season()`, windows table 2026–2030; script prompt gets a SEASON NOTE to retell any fasting mention as "last Ramadan").
